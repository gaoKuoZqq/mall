...
public class Pay_info {
	...
	public Pay_info(Integer id, Integer user_id, String order_no, Integer pay_platform, String platform_number,
			String platform_status, java.util.Date create_time, java.util.Date update_time) {
		super();
		this.id = id;
