				...
				<div class="col-sm-12">
					...
					<ul class="nav nav-tabs">
						...
						<li role="presentation" class="active">
							<a href="${ctx}/product/goModify.action">更改商品</a>
						</li>
					</ul>
					<!--
                    	描述：功能区上部小导航,结束
					...
					<form id="addForm" action="${ctx }/product/add.action" method="post" enctype="multipart/form-data">
						<div class="form-group" style="margin-top:10px;"/>
							商品名称
							<input id="name" id="name" class="form-control" value='${product.name }'/>
							商品副标题
							<input id="subtitle" class="form-control" value='${product.subtitle }'/>
							库存数量
							...
							<!-- kindEditor -->
							 <div  class="form-group">
						  	 <label >产品主图</label>
						  	 <div>
					           <img alt="" id="imgId" src="/pic/${product.main_image}" width=100 height=100>
							 ...
							 <div class="form-group">
							  	<label>商品描述</label>
							  	 <textarea style="width:900px;height:300px;visibility:hidden;" name="detail" id="detail">${product.detail }</textarea>
							 </div>
						</div>
						<input type="button" value="修改" class="btn btn-success btn-sm btn-block" onclick="modifyProduct()"/>
					<!-- 功能区,结束 -->
					</form>
				</div>
				<!--
